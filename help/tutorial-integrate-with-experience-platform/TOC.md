...
+ Experience Platform 데이터를 Campaign으로 가져오기{#import-experience-platform-data-into-campaign}
...
+ 캠페인 로그를  Experience Platform으로 내보내기{#export-campaign-logs-into-experience-platform}
   + [내보내기 워크플로 만들기(1부)](/help/tutorial-integrate-with-experience-platform/workflow-to-find-last-modified-date.md)
   + [내보내기 워크플로 만들기(2부)](/help/tutorial-integrate-with-experience-platform/extract-format-save-data-to-external-account.md)
