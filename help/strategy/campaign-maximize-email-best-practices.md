...
전략으로 이동하기 전에 캠페인 결과에 영향을 줄 수 있는 가장 일반적인 스팸 필터 문제를 인식하는 것이 중요합니다. 1년 이상 이메일을 열지 않은 비활성 구독자에게 이메일을 계속 보내는 경우 다음과 같은 문제가 발생할 수 있습니다.
...
[고객 성공](https://experienceleague.adobe.com/en/docs/customer-success/customer-success/overview) 허브에서 전략 및 사고 리더십에 대해 자세히 알아보세요.
