...
1. [캠페인 시작](https://experienceleague.adobe.com/ko/docs/campaign-web/v8/campaigns/gs-campaigns){target="_blank"}
2. [캠페인 액세스 및 관리](https://experienceleague.adobe.com/ko/docs/campaign-web/v8/campaigns/manage-campaigns){target="_blank"}
3. [첫 번째 캠페인 만들기](https://experienceleague.adobe.com/ko/docs/campaign-web/v8/campaigns/create-campaigns){target="_blank"}
...
3. **전자 메일 및 확인 로그 보내기**
   ...
   * [전자 메일 준비 및 보내기](https://experienceleague.adobe.com/ko/docs/campaign-web/v8/msg/email/monitor/prepare-send){target="_blank"}
   * [게재 전송 예약](https://experienceleague.adobe.com/ko/docs/campaign-web/v8/msg/email/monitor/schedule-sending){target="_blank"}
   * [게재 로그 모니터링](https://experienceleague.adobe.com/ko/docs/campaign-web/v8/msg/email/monitor/delivery-logs){target="_blank"}
...
* [메시지에 오퍼 추가](https://experienceleague.adobe.com/ko/docs/campaign-web/v8/msg/offers){target="_blank"}
...
<img alt="리드" src="_assets/email_report.jpeg">
</a>
...
<img alt="전반적 보고서" src="_assets/push_report.jpeg">
</a>
<div>
...
* [Adobe Experience Manager Assetsas a Cloud Service 으로 자산 관리](https://experienceleague.adobe.com/ko/docs/campaign-web/v8/integrations/aem-assets){target="_blank"}
* [Adobe Experience Manager as a Cloud Service으로 템플릿 관리](https://experienceleague.adobe.com/ko/docs/campaign-web/v8/integrations/aem-content){target="_blank"}
...
* Adobe Analytics 데이터 사용 및 KPI 공유. [자세히 알아보기](https://experienceleague.adobe.com/ko/docs/campaign/campaign-v8/connect/ac-aa){target="_blank"}
* Adobe Experience Cloud(Adobe Audience Manager)를 통한 대상자 공유. [자세히 알아보기](https://experienceleague.adobe.com/ko/docs/campaign-classic/using/integrating-with-adobe-experience-cloud/audience-sharing/sharing-audiences-with-adobe-experience-cloud){target="_blank"}
* Adobe Target과 통합. [자세히 알아보기](https://experienceleague.adobe.com/ko/docs/campaign/campaign-v8/connect/ac-at){target="_blank"}
* Adobe Experience Cloud 트리거와 통합. [자세히 알아보기](https://experienceleague.adobe.com/ko/docs/campaign/campaign-v8/connect/ac-triggers){target="_blank"}
