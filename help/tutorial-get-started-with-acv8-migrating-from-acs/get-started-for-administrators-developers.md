...
2. 클라이언트 콘솔에서 사용자 권한을 관리하는 방법을 알아봅니다. 방법 알아보기
   ...
   * Admin Console을 통해 사용자 추가
   * 제품 프로필 설정
   * 운영자 그룹 만들기 및 명명된 권한 할당
   * 운영자 그룹⇄ 제품 프로필 매핑
...
* [채널 설정 위치](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/push/push-data-collection){target="_blank"}
