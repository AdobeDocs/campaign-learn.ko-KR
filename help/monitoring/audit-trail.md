...
[!UICONTROL Audit Trail]은(는) 액션의 전체 목록과 Adobe Campaign 내에서 발생하는 이벤트를 실시간으로 캡처합니다.[!UICONTROL Audit Trail] 기능에는 다음 같은 질문에 답하기 위해 데이터 기록에 액세스할 수 있는 셀프 서비스 방법이 포함되어 있습니다.
...
>[!VIDEO](https://video.tv.adobe.com/v/3444241?captions=kor&quality=12&learn=on){transcript=true}
