...
+ 프로세스 관리 및 자동화{#process-management}
   ...
   + 타겟팅 워크플로 {#targeting-workflows}
      + [타겟팅 워크플로 만들기](/help/process-management/create-a-targeting-workflow.md)
...
+ 데이터 관리 {#data-management}
   ...
   + [튜토리얼: SOAP API 사용](https://experienceleague.adobe.com/docs/campaign-learn/use-soap-apis/introduction.html?lang=ko)
+ 다른 솔루션과 연결 {#connect}
